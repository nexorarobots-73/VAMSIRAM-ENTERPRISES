    ...
    <section className="relative bg-background overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-24 text-center md:py-32 lg:py-40">
        <h1 className="text-4xl font-extrabold tracking-tight md:text-6xl lg:text-7xl font-headline">
          ...
          <span className="block bg-gradient-to-r from-blue-400 via-green-400 to-purple-500 bg-clip-text text-transparent">Crafting the Future of Robotics</span>
        </h1>
        <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground md:text-xl">
          At Nexora Robotics, we are at the forefront of the robotics revolution. Our mission is to engineer intelligent machines that transform industries, enhance human capabilities, and solve real-world challenges.
        </p>
