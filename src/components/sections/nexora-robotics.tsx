...
export function NexoraRobotics() {
  return (
    <section id="robotics" className="py-16 lg:py-24 bg-secondary/50">
      <div className="container mx-auto px-4">
        <Card className="max-w-4xl mx-auto shadow-lg bg-gradient-to-r from-primary to-accent p-1">
          <CardContent className="bg-background rounded-lg p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="mt-2 text-lg text-muted-foreground">
                Explore our innovations in real-time automation, robotics, and smart IoT platforms.
              </p>
            </div>
